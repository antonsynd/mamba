...
TEST(List, CopyNonEmpty) {
  ...
  const auto actual_copy_items = as_vector<IntType>(copy);
...
TEST(List, ExtendEmptyAndNonEmptyOtherObject) {
  // If
  List<IntWrapper> l;
  const List<IntWrapper> other = {IntWrapper(1), IntWrapper(3), IntWrapper(5),
                                  IntWrapper(7)};
...
TEST(List, ExtendNonEmptyAndNonEmptyOtherObject) {
  // If
  List<IntWrapper> l = {IntWrapper(9), IntWrapper(11), IntWrapper(13)};
  const List<IntWrapper> other = {IntWrapper(1), IntWrapper(3), IntWrapper(5),
                                  IntWrapper(7)};
...
TEST(List, AdditionOperatorObject) {
  // If
  const List<IntWrapper> l = {IntWrapper(9), IntWrapper(11), IntWrapper(13)};
  const List<IntWrapper> other = {IntWrapper(1), IntWrapper(3), IntWrapper(5),
                                  IntWrapper(7)};
...
TEST(List, MinNonEmptyObject) {
  // If
  const List<IntWrapper> l = {IntWrapper(5), IntWrapper(7), IntWrapper(3),
                              IntWrapper(1)};
...
TEST(List, ReplaceSliceZeroStepObject) {
  ...
  List<IntWrapper> l = {IntWrapper(1), IntWrapper(3), IntWrapper(5),
                        IntWrapper(1), IntWrapper(7)};
  const List<IntWrapper> other = {IntWrapper(2), IntWrapper(4), IntWrapper(6)};
...
TEST(List, InsertIntoNonEmptyObject) {
  // If
  List<IntWrapper> l = {IntWrapper(1), IntWrapper(3), IntWrapper(7)};
...
TEST(List, EqualitySameObjectObject) {
  ...
  const List<IntWrapper> l = {IntWrapper(1), IntWrapper(3), IntWrapper(5),
                              IntWrapper(7)};
  const List<IntWrapper> copy = {IntWrapper(1), IntWrapper(3), IntWrapper(5),
                                 IntWrapper(7)};
  ASSERT_NE(&l, &copy);
...
TEST(List, NativeEqualityDifferentTypeObject) {
  ...
  const List<IntWrapper> l = {IntWrapper(1), IntWrapper(3), IntWrapper(5),
                              IntWrapper(7)};
  const List<FloatWrapper> m = {FloatWrapper(1.0), FloatWrapper(3.0),

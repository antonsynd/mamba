...
#include "mamba/builtins/__types/byte_array.hpp"  // IWYU pragma: export
#include "mamba/builtins/__types/bytes.hpp"       // IWYU pragma: export
...
using ByteArrayType = details::ByteArray;
using BytesType = details::Bytes;

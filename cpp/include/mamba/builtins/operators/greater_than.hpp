...
__types::Bool Gt(const T& t, const U& u) {
  return t.Gt(u);
}

template <__concepts::Object T, __concepts::Object U>
__types::Bool Gt(const T& t, const __memory::handle_t<U>& u) {
  return t.Gt(*u);
}
...
template <__concepts::Object T, __concepts::Object U>
__types::Bool Gt(const __memory::handle_t<T> t, const __memory::handle_t<U> u) {
  return t->Gt(*u);
}

template <__concepts::Object T, __concepts::Object U>
__types::Bool Gt(const __memory::handle_t<T>& t, const U& u) {
  return t->Gt(u);
}
